...
const Dashboard = () => {
  ...
  return (
    <div className={`page bg-gray-100 ${page===DASHBOARD_PAGE&&"dashboard-show"}`}>
      <motion.nav
        initial={false}
      ...
      <div className="flex-grow bg-white w-100 rounded-lg shadow-md p-4 mb-4 overflow-y-auto">
        
      </div>
      <div className="flex justify-between items-center" style={{zIndex:55}}>
      <NavigationIcon direction="left" />
        <h1 className="text-2xl font-bold text-center">{"Title jdnscjsdncj"}</h1>
